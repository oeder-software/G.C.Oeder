...
document.getElementById("software").setAttribute("href", "http://oeder-software.github.io/dev" )
 */
...
if (
  ...
  document.title == "familynicodk" ||
  document.title == "andenkendk"
) {
...
if (
  document.title == "vorderseite" ||
  document.title == "letterchede" ||
  document.title == "letterbugde" ||
  document.title == "familynicode" ||
  document.title == "letterlinde" ||
  document.title == "andenkende"
) {
