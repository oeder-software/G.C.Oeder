...
let manuDe = [
	...
	"betreffend Georg Christian Oeder, Doktor der Medizin, seine Disputation „De Irritabilitate“ ",
	"Gründliche Beleuchtung, Der im Jahr 1755. herausgekommenen sogenannten Vertheitigten Territorial- und Jurisdiction-Gerechtsamen der Reichs-Stadt Dinckelsbül"
];
let manuDk = [
	...
	"Ang. Georgii Christiani Oederi Doctor i Medicinen Hans Disputatz de Irritabilitate holden paa Kiøbenhavns Universitet",
	"Gründig Oplysning, Over de i Aaret 1755 udkomne saa kaldte Forsvarede Territoriale og Jurisdictions-Rettigheder for Rigsstaden Dinckelsbül."
];
...
let manuEn = [
	...
	"concerning Georg Christian Oeder, Doctor of Medicine, his dissertation “De Irritabilitate”",
];
...
let manuHyperLinks = [
	...
	"https://www.digitale-sammlungen.de/en/view/bsb10323235?page=5",
	"",
	"",
	"",
	"",
...
let artDe = [
	...
	"Gedanken nüber die französ. schulden und über Hammond.",
	...
	"2. Nachricht von hiesiger Landes-Vermessung.",
	"3. Fortsetzung der Nachricht von hiesiger Landes-Vermessung.",
	"4. Fortsetzung der Nachricht von hiesiger Landes-Vermessung.",
...
let artDk = [
	...
	"3. Fortsættelse af den hersteds Landmåling.",
	"4. Fortsættelse af den hersteds Landmåling.",
...
let artEn = [
	...
	"3. Continuation of the report on the local land survey.",
	"4. Continuation of the report on the local land survey.",
...
"https://ds.ub.uni-bielefeld.de/viewer/image/2085009_002/7/",
"https://ds.ub.uni-bielefeld.de/viewer/image/2085009_002/206",
