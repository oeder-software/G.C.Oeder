...
let ContentGerman = [
  ...
  "IV.Allerunterthänigste Vorstellung,. betreffend, in wie weit dem Bauernstande im Königreiche Dänemark vorjetzo die personelle Freyheit zu schenken seyn mögte.",
  ...
  "Erläuterung des ersten Grundsatzes.",
  "Erläuterung des zweyten Grundsatzes.",
  "Erläuterung des dritten Grundsatzes.",
