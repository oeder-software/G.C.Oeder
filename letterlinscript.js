...
if (path == "letterlindk") {
  ...
  document.getElementById("bio3").setAttribute("data", "/bio/DK-forsskaal.txt");
  ...
  document.getElementById("bio12").setAttribute("data", "/bio/DK-conflict.txt");
  ...
  document.getElementById("bio16").setAttribute("data", "/bio/DK-vaillant.txt");
...
if (path == "letterlinen") {
  ...
  document.getElementById("bio3").setAttribute("data", "/bio/EN-forsskaal.txt");
  document.getElementById("bio3").style.height = "190px";
  ...
  document.getElementById("bio12").setAttribute("data", "/bio/EN-conflict.txt");
  ...
  document.getElementById("bio15").style.height = "150px";
  document.getElementById("bio16").setAttribute("data", "/bio/EN-vaillant.txt");
  document.getElementById("bio16").style.height = "150px";
...
if (path == "letterlinde") {
  ...
  document.getElementById("bio3").setAttribute("data", "/bio/de-forsskaal.txt");
  ...
  document.getElementById("bio12").setAttribute("data", "/bio/de-conflict.txt");
  document.getElementById("bio12").style.height = "320px";
  document
    .getElementById("bio13")
  ...
  document.getElementById("bio15").style.height = "150px";
  document.getElementById("bio16").setAttribute("data", "/bio/de-vaillant.txt");
